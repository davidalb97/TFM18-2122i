...
class MyEnsembleV2(MyBaseRegressor):
    use_regression: bool
    ...
    def __init__(self):
        ...
        decision_tree_max_features = 9              # Best result
        ...
        random_forest_max_features = 7              # Best result
        feature_count = 11
            ...
            self.__base_stacking_model = StackingRegressor(
                estimators=[
                    ('dtr', DecisionTreeRegressor(
                        ...
                        min_samples_split=2,
                        min_samples_leaf=1,
                        max_features=decision_tree_max_features,
    ...
    def get_algorithm_type(self) -> AlgorithmType:
        return AlgorithmType.ML_ENSEMBLE_V2
