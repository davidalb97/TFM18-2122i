...
%\def\glslk#1{\lowercase{\gls{#1}}}
%\newcommand{\glslk}[1]{\lowercase{\gls{#1}}}
...
%TODO Disabled list of Tables! 
%\addlisttofrontmatter{\conditionalLoT}    % The List of Tables.
\addlisttofrontmatter{\conditionalLoL}        % The List of Code Listings.

%\addlisttofrontmatter{\renewcommand{\glsnamefont}[1]{\makefirstuc{#1}} \printnoidxglossary} %  default: type=main,  Glossary. Comment to omit.
...
\addlisttofrontmatter{
    ...
    \renewcommand*{\firstGls}[1]{\empty\Gls{#1}}
    \let\firstchar\capitalisewords\printnoidxglossaries
    \renewcommand*{\firstGls}[1]{\empty\gls{#1}}
} % The List of Abreviations 
%\addlisttofrontmatter{\renewcommand*{\firstGls}[1]{\empty\Gls{#1}}\let\firstchar\capitalisewords\printnoidxglossaries\renewcommand*{\firstGls}[1]{\empty\gls{#1}}} % The List of Abreviations 
%\addlisttofrontmatter{\renewcommand{\glsnamefont}[1]{\MakeUppercase{#1}} \printnoidxglossary[type=acronym]} % The List of Abreviations 
...
\chapterfile{chapter1-introduction}
\chapterfile{chapter2-stateOfArt}
\chapterfile{chapter3-delopment}
\chapterfile{chapter4-planning}
...
% TODOS already implemented on an external package,
% So this is not needed
%\usepackage{xassoccnt} % Count \todo{} calls
%\newcounter{todocount}
%\DeclareTotalAssociatedCounters{todocount}{totalTodoCount}
%\newcommand\todo[1]{\refstepcounter{todocount}\textcolor{red}{\textbf{TODO} #1}}
%\newcommand{\TODOcount}{\huge{\textbf{\textcolor{red} {Number of TODOs:} \TotalValue{totalTodoCount}}}}
