...
\newglossaryentry{XGBoost}{
    name={XGBoost},
    description={Extreme Gradient Boosting Regression Tree}
}

\newglossaryentry{LightGBM}{
    name={LightGBM},
    description={Light Gradient Boosting Regression Tree}
}

\newglossaryentry{bigData}{
    name={big data},
    description={\todo[inline]{TODO - Big Data}}
}

\newglossaryentry{neuralNetworks}{
    name={Neural Networks},
    description={\todo[inline]{TODO - Neural Networks}}
}
